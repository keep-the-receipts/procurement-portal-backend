"""
Django settings for procurement_portal_backend project.
...
PROJ_DIR = ROOT_DIR.path("procurement_portal_backend")
...
INSTALLED_APPS = [
    ...
    "procurement_portal_backend.records.apps.RecordsConfig",
...
ROOT_URLCONF = "procurement_portal_backend.urls"

TEMPLATES = [
    {
        "BACKEND": "django.template.backends.django.DjangoTemplates",
        "DIRS": ["procurement_portal_backend/templates"],
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
...
WSGI_APPLICATION = "procurement_portal_backend.wsgi.application"
